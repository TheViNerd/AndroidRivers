...
val SLIDE_MENU_READ: Int = 0
val SLIDE_MENU_WRITE: Int = 1
val SLIDE_MENU_DONATE: Int = 2
val SLIDE_MENU_PRAISE: Int = 3
val SLIDE_MENU_TRY_OUT: Int = 4
val SLIDE_MENU_GOOGLE_NEWS: Int = 5
val SLIDE_MENU_KAYAK_DEALS: Int = 6
val SLIDE_MENU_FEEDBACK: Int = 7
val SLIDE_MENU_CRAIGSLIST_LISTING: Int = 8
...
fun fillSlidingMenuNavigation(navs: List<NavItem>, view: View, onClick: (NavItem) -> Unit) {
    ...
    val adapter = object : ArrayAdapter<NavItem>(view.context!!, R.layout.slide_menu_item, navs){
